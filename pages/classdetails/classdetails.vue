<template>
	<view class="view-page">
		<div class="info">
			<view>
				<span class="cu-tag">语文</span>
				<span class="cu-tag">胡老师</span>
			</view>
			<view class="name">
				主题：第七单元课堂测试
			</view>
			<view>2020.04.02 8:00-8:40</view>
		</div>
		<div class="modbox">
			...
			<view class="tablebox">
				<view class="cu-bar bg-white">
					...
					<view class="action ft20 ">
						...
						<text class="margin-left">答对数量 <text class="text-red margin-left-xs margin-right-xs">{{detail.answerTrueQuestionCount}}</text> 题</text>
					</view>
				</view>
				<view class="table">
		...
		<div class="modbox">
			<view class="tablebox">
				<view class="cu-bar bg-white">
					...
					<view class="action ft20 ">
						<text>答题数量共 <text class="text-red margin-left-xs margin-right-xs">5</text> 题</text>
					</view>
				</view>
				<view class="table">
					<view class="table-hd flex justify-between">
					...
					<view class="table-bd">
						<view class="table-td flex justify-between">
							<view>1</view>
							<view class="flex-sub">单题单选</view>
							<view class="flex-sub">
	...
	export default {
		data() {
			return {
				...
				pixelRatio: 1,
				detail: {
					"stuCorrectAccuracy": "50.00%",
					"defeatStuCount": "33.33%",
					"joinStudentCount": 3,
					"averageCorrectAccuracy": "33.33%",
					"bestCorrectAccuracy": "50.00%",
					"answerQuestionCount": 1,
					"sendQuestionCount": 2,
					"answerTrueQuestionCount": 1,
					"classRank": 1,
					"totalScore": 13,
					"studentAnalyseDetail": {
						...
						"questionList": [{
								...
								"inputAnswer": "A",
								"answerResult": "true",
								"answerDatetime": "2020-04-02 20:21:45",
								"speed": "1.76",
								"score": 13,
								"voiceUrl": null
							},
							{
								...
								"inputAnswer": "",
								"answerResult": "false",
								"answerDatetime": "2020-04-16 10:37:28",
								"speed": "0",
								"score": 0,
								"voiceUrl": null
							}
					...
					"first10StudentList": [{
						...
						{
							"stuCode": "a09ef1b5755a4f3e8439313073d577e6",
							"stuName": "香香",
							"classRank": 2,
							"className": null,
							"accuracy": "50.00%",
						...
						{
							"stuCode": "a7467c41d95b470781f7896b1a8eabca",
							"stuName": "一一",
							"classRank": 3,
							"className": null,
							"accuracy": "0.00%",
			...
			getstudentAnalyseDetail() {
				postajax(api.studentAnalyseDetail, {
				...
				}).then(da => {
					{
						console.log(da)
						if (da.code == 0) {
							this.studentAnalyseDetail = da.data;
						}
					}
				})
			},
